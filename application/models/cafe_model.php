...
public function list_cities_by_distance($lat1,$lon1){
	...
	$cities = $this->rise_cafe->ListRegion(0);
  	for($i=0;$i<count($cities);$i++){
		...
		$stars = array(-1=>0,0=>0,1=>0,2=>0,3=>0);
...
EOD;
  ...
  function update($cafeID, $name,$region,$address,$latitude,$longitude,$hours,$chain){
	...
	$this->rise_cafe->SetCafe(	$newCafe->ID, 
								...
								strtotime(date("Y-m-d", strtotime($hours["mon_open"]))),
								strtotime(date("Y-m-d", strtotime($hours["mon_close"]))),
								strtotime(date("Y-m-d", strtotime($hours["tue_open"]))),
								strtotime(date("Y-m-d", strtotime($hours["tue_close"]))),
								strtotime(date("Y-m-d", strtotime($hours["wed_open"]))),
								strtotime(date("Y-m-d", strtotime($hours["wed_close"]))),
								strtotime(date("Y-m-d", strtotime($hours["thu_open"]))),
								strtotime(date("Y-m-d", strtotime($hours["thu_close"]))),
								strtotime(date("Y-m-d", strtotime($hours["fri_open"]))),
								strtotime(date("Y-m-d", strtotime($hours["fri_close"]))),
								strtotime(date("Y-m-d", strtotime($hours["sat_open"]))),
								strtotime(date("Y-m-d", strtotime($hours["sat_close"]))),
								strtotime(date("Y-m-d", strtotime($hours["sun_open"]))),
								strtotime(date("Y-m-d", strtotime($hours["sun_close"]))),
								$chain);
