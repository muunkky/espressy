        ...
        <div class="row">
        	<div class="col-xs-12">
            	<h3 style="<?=($cafe->Star_Rating==0?"margin: 0;":"")?>">
	            	<a target="_blank" href="http://maps.google.com/?q=<?=$cafe->Name;?>%20near%20<?=$cafe->Address;?>" style="padding:3px;color:black;margin-right:15px;border:1px solid #DDD;border-radius:5px;background-color:transparent;" class="btn">
