<li class="list-group-item" style="<?=($cafe->Star_Rating==0?"padding-top: 0;padding-bottom: 0;":"")?>">
        ...
        <div class="row">
        	<div class="col-xs-12">
            	<h3 style="<?=($cafe->Star_Rating==0?"margin: 0;":"")?>">
	            	<a target="_blank" href="http://maps.google.com/?q=<?=$cafe->Name;?>%20<?=$cafe->Address;?>%20near%20<?=$cafe->Latitude;?>,<?=$cafe->Longitude;?>" style="padding:3px;color:black;margin-right:15px;border:1px solid #DDD;border-radius:5px;background-color:transparent;" class="btn">
						...
						<li class="list-group-item">
							<div class="row">
								<div class="col-xs-10 text-left">
      							...
      							<div class="col-xs-2 text-center">
					                <h3>
						            	<a target="_blank" href="http://maps.google.com/?q=<?=$s->Name;?> near <?=$s->Latitude;?>,<?=$s->Longitude;?>" style="padding:3px;color:black;margin-right:15px;border:1px solid #DDD;border-radius:5px;background-color:transparent;" class="btn">
    ...
    <?php }
		if($reviewer){
	    	...
	    	$this->load->view("list/review",array("cafe_id"=>$cafe->ID,"stars"=>$cafe->Star_Rating));
