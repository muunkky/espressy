<form id="update_form">
	...
	<div class="form-group">
	  	<label for="cafe_name">Cafe Name
	  		<input type="text" class="form-control" id="cafe_name" value="<?=$cafe->Name?>" required>
		</label>
		...
		<label for="cafe_address">Address
			<input type="text" class="form-control" id="cafe_address" value="<?=$cafe->Address?>" required>
		</label>
	</div>
	<legend>
		GPS Position
	...
	<div class="form-group">
	  ...
	  <input type="text" class="form-control" id="cafe_latitude" value="<?=$cafe->Latitude?>" required>
	</div>
	<div class="form-group">
	  <label for="cafe_address">Longitude</label>
	  <input type="text" class="form-control" id="cafe_longitude" value="<?=$cafe->Longitude?>" required>
	  <script>
	...
	<div class="form-group">
		<h3>
        	<a id="map_test" target="_blank" href="http://maps.google.com/?q=<?=$cafe->Name?>%20near%20<?=$cafe->Latitude?>,<?=$cafe->Longitude?>"
	...
	<div class="form-group">
	  <label for="mon_open">
		Monday Open
	  	<input type="time" class="form-control" id="mon_open" placeholder="Monday Open" value="<?=$cafe->Monday_Open?>" required>
	  </label>
	  <label for="mon_close">
		Monday Close
	  	<input type="time" class="form-control" id="mon_close" placeholder="Monday Close" value="<?=$cafe->Monday_Close?>" required>
	  </label>
	  <br />
	  <label for="tue_open">
		Tuesday Open
	  	<input type="time" class="form-control" id="tue_open" placeholder="Tuesday Open" value="<?=$cafe->Tuesday_Open?>" required>
	  </label>
	  <label for="tue_close">
		Tuesday Close
	  	<input type="time" class="form-control" id="tue_close" placeholder="Tuesday Close" value="<?=$cafe->Tuesday_Close?>" required>
	  </label>
	  ...
	  <label for="wed_open">
		Wednesday Open
	  	<input type="time" class="form-control" id="wed_open" placeholder="Wednesday Open" value="<?=$cafe->Wednesday_Open?>" required>
	  </label>
	  <label for="wed_close">
		Wednesday Close
	  	<input type="time" class="form-control" id="wed_close" placeholder="Wednesday Close" value="<?=$cafe->Wednesday_Close?>" required>
	  </label>
	    <label>
	  ...
	  <label for="thu_open">
		Thursday Open
	  	<input type="time" class="form-control" id="thu_open" placeholder="Thursday Open" value="<?=$cafe->Thursday_Open?>" required>
	  </label>
	  <label for="thu_close">
		Thursday Close
	  	<input type="time" class="form-control" id="thu_close" placeholder="Thursday Close" value="<?=$cafe->Thursday_Close?>" required>
	  </label>
	    <label>
	  ...
	  <label for="fri_open">
		Friday Open
	  	<input type="time" class="form-control" id="fri_open" placeholder="Friday Open" value="<?=$cafe->Friday_Open?>" required>
	  </label>
	  <label for="fri_close">
		Friday Close
	  	<input type="time" class="form-control" id="fri_close" placeholder="Friday Close" value="<?=$cafe->Friday_Close?>" required>
	  </label>
	    <label>
	  ...
	  <label for="sat_open">
		Saturday Open
	  	<input type="time" class="form-control" id="sat_open" placeholder="Saturday Open" value="<?=$cafe->Saturday_Open?>" required>
	  </label>
	  <label for="sat_close">
		Saturday Close
	  	<input type="time" class="form-control" id="sat_close" placeholder="Saturday Close" value="<?=$cafe->Saturday_Close?>" required>
	  </label>
	    <label>
	  ...
	  <label for="sun_open">
		Sunday Open
	  	<input type="time" class="form-control" id="sun_open" placeholder="Sunday Open" value="<?=$cafe->Sunday_Open?>" required>
	  </label>
	  <label for="sun_close">
		Sunday Close
	  	<input type="time" class="form-control" id="sun_close" placeholder="Sunday Close" value="<?=$cafe->Sunday_Close?>" required>
	  </label>
	    <label>
	...
	<div class="form-group">
          <input style="margin-left:25px;" type="radio" name="newcafe_review_radio" id="newcafe_review_threestar" value="3" <?=$cafe->Star_Rating==3?"checked":""?> required>
    ...
    <div class="form-group">
          <input style="margin-left:25px;" type="radio" name="newcafe_review_radio" id="newcafe_review_twostar" value="2" <?=$cafe->Star_Rating==2?"checked":""?> >
          <label class="radio-inline" ><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span> Two Star
          </label>
    </div>   
    <div class="form-group">
          <input style="margin-left:25px;" type="radio" name="newcafe_review_radio" id="newcafe_review_onestar" value="1" <?=$cafe->Star_Rating==1?"checked":""?>>
          <label class="radio-inline" ><span class="glyphicon glyphicon-star"></span> One Star
          </label>
    </div>
    <div class="form-group">
          <input style="margin-left:25px;" type="radio" name="newcafe_review_radio" id="newcafe_review_HM" value="0"  <?=$cafe->Star_Rating==0?"checked":""?>>
          <label class="radio-inline" >HM
          </label>
    </div>
    <div class="form-group">
          <input style="margin-left:25px;" type="radio" name="newcafe_review_radio" id="newcafe_review_blackstar" value="-1"  <?=$cafe->Star_Rating==-1?"checked":""?>>
