...
public function get_city_stars(){
  ...
  $id = $this->input->post("cafe_id");
	...
	$cafe_rating_comments = $this->input->post("cafe_rating_comments");
	$chain = $this->input->post("cafe_chain");
	$mon_open = $this->input->post("mon_open_".$id);
	$tue_open = $this->input->post("tue_open_".$id);
	$wed_open = $this->input->post("wed_open_".$id);
	$thu_open = $this->input->post("thu_open_".$id);
	$fri_open = $this->input->post("fri_open_".$id);
	$sat_open = $this->input->post("sat_open_".$id);
	$sun_open = $this->input->post("sun_open_".$id);
	$mon_close = $this->input->post("mon_close_".$id);
	$tue_close = $this->input->post("tue_close_".$id);
	$wed_close = $this->input->post("wed_close_".$id);
	$thu_close = $this->input->post("thu_close_".$id);
	$fri_close = $this->input->post("fri_close_".$id);
	$sat_close = $this->input->post("sat_close_".$id);
	$sun_close = $this->input->post("sun_close_".$id);
